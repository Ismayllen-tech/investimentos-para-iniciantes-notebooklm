...
Compreensão de inflação
Entendimento de liquidez
Noção de volatilidade
Este miniguia foi elaborado a partir de materiais institucionais públicos do:
...
Se um investimento rende menos que a inflação, ocorre perda real de poder de compra.
...
Geralmente menor volatilidade

📌 Renda Variável
Retorno não é previamente definido
Sofre oscilações conforme oferta e demanda
